...
role_ids = [1102933903062339614]
guild_ids = [1066139205060804679, 1030138986758406286]


class RoleButtonFour(discord.ui.Button):
...
class ButtonRoleCogFour(commands.Cog):
    """
    ...
    async def postfour(self, ctx: discord.ApplicationContext):
        """Slash command to post a new view with a button for each role."""

        # timeout is None because we want this view to be persistent.
        view = discord.ui.View(timeout=None)
        filename = f"reactroles_stream.png"
        ...
        for role_id in role_ids:
            ...
            view.add_item(RoleButtonFour(role))
...
def setup(bot):
    bot.add_cog(ButtonRoleCogFour(bot))
